...
class LTetromino(Tetromino):
    ...
    def __init__(self, size, pivot=Position(0, 4), block_size=40):
        ...
        self.blocks[1][0] = SquareBlock(Position(1, 0), (255, 0, 0), block_size)
        self.blocks[1][1] = SquareBlock(Position(1, 1), (255, 0, 0), block_size)
        self.blocks[1][2] = SquareBlock(Position(1, 2), (255, 0, 0), block_size)
        self.blocks[2][2] = SquareBlock(Position(2, 2), (255, 0, 0), block_size)
